...
Inspired by the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md), the hope is to create an **exhaustive** list of objects that could appear in the human abdomen, along with all open datasets relevant to each ebject. See [awesome_anatomy.md](awesome_anatomy.md) for more information.
